...
pandoc -s --toc --highlight-style pygments -c style.css -N -o atelier-es6.html \
  00-intro/README.md \
	...
	02-models-sync/02-01-THEORIE.md \
	02-models-sync/02-02-PRATIQUE.md \
	02-models-sync/corrections/corrections.md \
	03-views-models/03-01-THEORIE.md \
	03-views-models/03-02-PRATIQUE.md \
	03-views-models/corrections/corrections.md \
	04-router/04-01-THEORIE.md \
	04-router/04-02-PRATIQUE.md \
	04-router/corrections/corrections.md
